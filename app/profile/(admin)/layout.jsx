      ...
      <body suppressHydrationWarning={true}>
        ...
        <div className="app relative">
          ...
          <main>
            ...
            <div className="drawer z-30 w-[280px] md:hidden block">
              <div className=" md:hidden block h-[85px]">

              </div>
              <input id="my-drawer-4" type="checkbox" className="drawer-toggle" />
              <div className="drawer-content w-[99vw] fixed top-0 flex items-center justify-end py-5 bg-white border-b border-gray-200 ">
                {/* Page content here */}
              ...
              <div className="drawer-side left-0 z-30">
                  ...
                  <div className="flex-row gap-3 text-[15px] font-light md:gap-5 items-center">
                    ...
                    <div className="absolute bottom-2 ">
                      ...
                      <div className="text-xs font-semibold flex  gap-1 justify-center my-2 flex-wrap w-[280px] text-center">
                        <Link href="/profile/aide"> <p className="border-b border-gray-800 flex items-center"> Aide et assistance<Dot /></p></Link>
                        <Link href="/profile/services"><p className="border-b border-gray-800 flex items-center">Condition de service<Dot /></p></Link>
                        <Link href="/profile/condition"><p className="border-b border-gray-800">Politique de confidentialité</p></Link>
                      </div>
                      <div>
            ...
            <div className="flex w-full h-[100dvh]  bg-neutral-50 gap-5">
              ...
              <div className="w-full flex  justify-center overflow-y-auto pb-12 p-2">
                {children}
              </div>
            </div>
