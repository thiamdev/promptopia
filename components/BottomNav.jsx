    ...
    return (
        <div className='w-full'>
            <div className='flex items-center mx-2  w-full my-2 justify-around px-2  py-2 text-xs  rounded-full'>
                ...
                <Link href="/busApp/depos" className={`${pathName === "/busApp/depos" ? "text-white font-semibold bg-orange-600 flex gap-1 items-center justify-center p-3 shadow-lg shadow-orange-200/75  rounded-full  " : ""} `}>
                <Search className="mx-auto w-4 h-4"/>
                <h1>Explorer</h1>
                </Link>
                <Link href="/busApp/historique" className={`${pathName === "/profile/create-prompt" ? "text-white font-semibold bg-orange-600 flex gap-1 items-center justify-center p-3 shadow-lg shadow-orange-200/75  rounded-full " : ""} `}>
